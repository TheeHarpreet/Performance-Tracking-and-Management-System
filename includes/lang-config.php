...
function translate($key) {
    $translations = array(
        "bm" => array(
            ...
            "Submit" => "Hantar",
            "Logout" => "Log Keluar",
            "Update User Details" => "Kemas kini butiran pengguna",
            "Please reset your password" => "Tolong set semula kata laluan",
            "Your password has been reset, your account is not secure until the password has been changed" => "",
            "Work to review" => " Kerja untuk disemak",
            "Overall Points" => "Mata keseluruhan",
            "Coauthor" => "Pengarang bersama",
            "Review Work" => "Semak Kerja",
            "Internal" => "Dalaman",
            "National" => "Nasional",
            "International" => "Antarabangsa",
            "Internal Project" => "Projek Dalaman",
            "External Project" => "Projek Luar",
            "Operations" => "Operasi",
            "Project Supervision" => "Penyeliaan Projek",
            "Local" => "tempatan",
            "Institute" => "Institusi",
            "District" => "Daerah",
            "State" => "Negeri",
            "Returned by" => "Dikembali oleh",
            "Date returned" => "Tarikh kembali",
            "Reason" => "Sebab",
            "Sort by" => "Diurus oleh",
